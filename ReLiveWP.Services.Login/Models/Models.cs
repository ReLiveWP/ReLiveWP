...
public record ConnectionModel(string Id, string Url, string Name, bool NeedsRelink);
...
public record ConnectedDeviceModel(string FriendlyName, string? Manufacturer, string? Model, string? Operator, string? PhoneNumber, string OSVersion, string Locale);