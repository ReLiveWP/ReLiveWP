...
public class ThumbnailResizerTests
{
    ...
    public void ProducesRequestedSizeForEachHubThumbnail(int size)
    {
        ...
        var thumbnail = resizer.ResizeAsync("webdav+abc", size, source).Result;
    ...
    public void PreservesAspectRatioOnPortraitSources()
    {
        ...
        var thumbnail = resizer.ResizeAsync("webdav+portrait", 800, source).Result;
    ...
    public void DoesNotUpscaleSmallSources()
    {
        ...
        var thumbnail = resizer.ResizeAsync("webdav+small", 800, source).Result;
    ...
    public void TranscodesPngToJpeg()
    {
        ...
        var thumbnail = resizer.ResizeAsync("webdav+png", 96, source).Result;
    ...
    public void ReturnsNullForContentThatIsNotAnImage()
    {
        ...
        Assert.Null(resizer.ResizeAsync("webdav+junk", 800, source).Result);
    }
    ...
    public void SecondCallForTheSameSizeIsServedFromCache()
    {
        ...
        var first = resizer.ResizeAsync("webdav+cached", 176, source).Result;

        // an empty stream would fail to decode, so a result here can only have come from the cache
        using var empty = new MemoryStream();
        var second = resizer.ResizeAsync("webdav+cached", 176, empty).Result;
